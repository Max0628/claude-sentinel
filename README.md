...
監控 Claude Pro 訂閱額度，在重要事件發生時主動發送 Discord 通知——包括 session 即將用盡、session 重置、以及週用量接近上限。

服務以 systemd 排程的 Podman container 形式運行在 home server 上，每 10 分鐘檢查一次。
...
| 4 | 週用量進度督促 | 週用量 < 90%，且已進入週期超過 24 小時 | 每小時一次 |
...
### Rule 3 — 週用量通知（50%、60%、70%）

```
Claude Pro 本週用量提醒

本週已使用      60%
本週 Reset      06/30 03:00
```
